...
| Файл | Действие |
|------|----------|
| `setup.bat` | Установить всё необходимое |
| `setup-and-build.bat` | Установить + собрать APK |
| `build.bat` | Собрать APK |

Проект приложения: [`../WebViewer/`](../WebViewer/)
